...
<body class="bg-gray-50 text-gray-700" <?php body_class(); ?>>
    ...
    <div class="sticky bg-gray-50 top-0 z-40 shadow-md">
        <header class="content md:flex md:justify-between h-auto items-center pb-5 md:pb-5" x-data="{ isOpen: false }">
            <div class="flex justify-between h-auto items-center">
                ...
                <button class="block md:hidden p-2 hover:bg-gray-200" @click="isOpen = !isOpen" @keydown.escape="isOpen = false">
    ...
    <div class="bg-gradient-to-r from-blue-800 to-blue-500">
        <div class="noteworthy content pb-5">
